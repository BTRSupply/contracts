...
import {IDiamondCut} from "../evm/interfaces/IDiamondCut.sol";
import {BTRDiamond} from "../evm/BTRDiamond.sol";
import {DiamondCutFacet} from "../evm/facets/DiamondCutFacet.sol";
import {DiamondLoupeFacet} from "../evm/facets/DiamondLoupeFacet.sol";
import {AccessControlFacet} from "../evm/facets/AccessControlFacet.sol";
import {RescuableFacet} from "../evm/facets/RescuableFacet.sol";
import {LibAccessControl} from "../evm/libraries/LibAccessControl.sol";
import {IERC173} from "../evm/interfaces/IERC173.sol";
...
contract DeployBTRDiamond is Script {
     ...
     */
    function initializeFacets(address deployer) internal {
    ...
    function generateAccessControlSelectors() internal pure returns (bytes4[] memory) {
        ...
        selectors[6] = AccessControlFacet.deployer.selector;
